...
import { DealToProductControlCodeRepository } from '../../rakuten/deal-to-product-control-code/models/repository';
...
export class RakutenRelations extends Relations {
  ...
  public deal = new DealToProductControlCodeRepository();
