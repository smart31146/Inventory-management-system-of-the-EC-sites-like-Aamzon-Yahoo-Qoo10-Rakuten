...
export const createValuesToSheets = async (params: AppendValuesParams,  newSheet: Date) => {
  ...
  .then(async () => {
    ...
    await sheets.spreadsheets.values.update({
      ...
      resource:{
          values: [["出荷確定日",	"在庫ID",	"LeoID", "販売元コード",	"販売チャネル",	"部門コード",	"部門名",	"商品名",	"単価", "定価", "税率",	"販売数量",	"注文数",	"売上",	"原価",	"送料",	"手数料",	"広告費",	"一次利益", "一次利益率", "広告費率", "販管費", "平均顧客単価", "平均顧客一次利益", "平均購入個数", "クリック数", "広告経由CV", "広告経由CVR", "CPC", "CPA", "ROAS", "広告経由売上"],...paramSheet.requestBody.values],
      }
    });
  })
  // エラーが起きた場合
